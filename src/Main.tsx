    ...
    return (
        <>
            ...
            <div class="col text-center" style="background: rgb(35,40,50);border-top: 2px solid rgb(75,80,90) ;border-bottom: 2px solid rgb(75,80,90) ;">
                <button class="btn btn-primary" type="button" style="background: rgb(55,60,70);margin-top: 15px;color: white;margin-bottom: 15px;margin-right: 5px;margin-left: 5px;width: 190px;height: 190px;font-size: 14px;border: 2px solid rgb(75,80,90);border-radius: 15px;">
